...
function ProductThumbnail({
  id, title, priceRange, imageSrc, altText,
}: Props) {
  return (
    <Paper className="product-container">
      ...
      <div className="product-atc-container">
        <Button className="atc-btn" variant="contained" color="secondary">Add to cart</Button>
        <Link href={{ pathname: '/product', query: { pid: id } }} as={`/products/${id}`} passHref>
          <Button className="details-btn" variant="contained" color="primary">Details</Button>
        </Link>
      </div>
    </Paper>
  );
